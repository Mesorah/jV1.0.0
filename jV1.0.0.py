                ...
                if ataque != 'p' and (chance_esquiva != 1 or chance_esquiva != 2 or chance_esquiva != 3):
                    ...
                    if critico_pessoa == 1 and chance_desvio_automatico != 2:
                        ...
                        if chance_acerto_monstro == 0 and chance_desvio_automatico != 2:  
                            ...
                            super1.append(1)
                            print(f'\033[1;36m{super1.count(1)}/2 Para carregar o super\033[m')
                            if super1.count(1) == 2:
                                vida_mostro -= 5
                                super1.clear()
                    ...
                    if vida_mostro <= 0:
                        ...
                        if critico_boss == 1 and chance_desvio_automatico != 1 and chance_acerto_jogador != 0 and super1.count(1) != 1 and critico_pessoa != 1:
                                #ataque crítico
                            vida_jogador -= 8
...
def mainm():
    ...
    print()
    print('\033[1;33mLuta 1x1 contra The Mega of The Blaster of The World')
    print('Você tem 7 de vida e causa 3 de dano contra ele com 25 de vida e causa 4 de dano')
    print('Você tem 3 poções de cura que curam 3 pontos de vida')
    print('Você e o boss têm 20% de chance de dar e receber críticos, causando o dobro de dano')
    print('Você tem 75% de chance de se esquivar, mas você da 2 de dano e se você não se esquivar você toma 3 de dano')
    print('Se você conseguir 2 ataque seguidos você usa o super causando 5 de dano')
    print('Tem 10% de chance de você ou o monstro se esquivar automáticamente\033[m')
    def vidam():
                ...
                if ataque == 'e':
                    ...
                    while lado != 'esquerda' or lado != 'direita':
                        ...
                        if lado[0] == 'd':
                            ...
                            print('erro')
                tot += 1
                if tot > 1 and vida_jogador < 7:
                    if cura > 0 and vida_jogador <= 4 and vida_jogador >= 1 :
                        while True:
                            poçao = str(input(f'\033[1;32mVocê tem {cura} poções de cura. Precione 1 para tomar uma poção de cura e 2 para não tomar:\033[m '))
                            if poçao == '1':
                                cura -= 1
                                vida_jogador += 3
                                print(f'Você usou uma poção de cura. Poções restantes: {cura}')
                                print(f'\033[1;36mVocê recuperou 3 pontos de vida\033[m')
                                break
                            elif poçao == '2':
                                break
                            else:
...
def maini():
    print('VOCÊ ESCOLHEU O MODO IMPOSSÍVEL')
    print('Acha que vai ganhar? 😂')
    print()
    print('\033[1;33mLuta 1x1 contra The Mega of The Blaster of The World')
    print('Você tem 5 de vida e causa 3 de dano contra ele com 25 de vida e causa 4 de dano')
    print('Você tem 2 poções de cura que curam 3 pontos de vida')
    print('Você e o boss têm 20% de chance de dar e receber críticos, causando o dobro de dano')
    print('Você tem 50% de chance de se esquivar, mas você da 2 de dano e se você não se esquivar você toma 3 de dano')
    print('Se você conseguir 2 ataque seguidos você usa o super causando 5 de dano')
    print('Tem 10% de chance de você ou o monstro se esquivar automáticamente\033[m')
    def vidai():
        vida_jogador = 5
                ...
                if ataque == 'e':
                    ...
                    while lado != 'esquerda' or lado != 'direita':
                        ...
                        if lado[0] == 'd':
                            ...
                            print('erro')
                tot += 1
                if tot > 1 and vida_jogador < 5:
                    if cura > 0 and vida_jogador <= 2 and vida_jogador >= 1 :
                        while True:
                            poçao = str(input(f'\033[1;32mVocê tem {cura} poções de cura. Precione 1 para tomar uma poção de cura e 2 para não tomar:\033[m '))
                            if poçao == '1':
                                cura -= 1
                                ...
                                print('\033[1;31mErro: Digite "1" para tomar poção ou "2" para não tomar./033[m')
                if ataque != 'p' and (chance_esquiva != 1 or chance_esquiva != 2):
                    continue
                else:   
                    chance_desvio_automatico = randint(1, 10)
                    chance_acerto_monstro = randint(0,1)
...
def modos():
    modos = ' '
    while modos != 'fácil' or modos != 'médio' or modos != 'impossível':
        modos = str(input('qual modo você irá escolher? [fácil/médio/impossível?] [digitar sair para fechar]')).lower()
        if modos[0] == 's':
            print('Seu merda')
            break
        elif modos[0] == 'f':
